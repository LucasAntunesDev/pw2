...
<body class="font-mono">
    ...
    <form action="guardar_links.php" method="post" 
    class="flex justify-center items-center gap-x-8 mt-4">

        <input type="text" name="link" id="link" placeholder="Digite o link"
        class="border-2 border-zinc-400 rounded-md">
