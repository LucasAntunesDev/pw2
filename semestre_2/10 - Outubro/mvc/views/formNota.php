...
<body>
    ...
    <div class="flex flex-col justify-center items-center gap-2">
        <h1 class="font-bold text-4xl text-emerald-500 my-4">Formulário de Nota</h1>
        <a href="notas.php" class="text-emerald-600 hover:underline">Voltar para a listagem</a>
